...
public class CauseInfo {
	...
	public CauseInfo(String timu_title, String timu_one, String timu_tow, String timu_three, String timu_four, String daan_one,
	...
	public String toString() {
		return "CauseInfo [timu_title=" + timu_title + ", timu_one=" + timu_one + ", timu_tow=" + timu_tow + ", timu_three=" + timu_three
