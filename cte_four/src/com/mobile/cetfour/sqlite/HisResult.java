...
public class HisResult {
	...
	public String name;
	public HisResult(String curTime, String useTime, String hisResult, String name) {
		super();
	...
	public String toString() {
		return "HisResult [curTime=" + curTime + ", useTime=" + useTime + ", hisResult=" + hisResult + ", name=" + name + "]";
	}
	@Override
	public int hashCode() {
		final int prime = 31;
