...
public class CauseInfoHasId {
	...
	public String types;
	public int reply;
	public CauseInfoHasId(int id, String timu_title, String timu_one, String timu_tow, String timu_three, String timu_four,
	...
	public String toString() {
		return "CauseInfoHasId [id=" + id + ", timu_title=" + timu_title + ", timu_one=" + timu_one + ", timu_tow=" + timu_tow
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		CauseInfoHasId other = (CauseInfoHasId) obj;
		if (daan_four == null) {
